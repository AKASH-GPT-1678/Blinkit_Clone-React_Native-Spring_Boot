    ...
    <View>
      ...
      <FlatList
        ...
        ListFooterComponent={() =>
            ...
            <View>
              <Pressable style={{height:100}} className='text-sm font-semibold p-1 h-[100px] w-[50%] absolute top-24 right-0 border-2 border-green-600'>
                <Text className='font-extrabold text-green-600 ml-3'>ADD ALL</Text>
              </Pressable>
                 <Pressable className='text-sm font-semibold p-1 w-[50%] absolute top-24 right-0 border-2 border-green-600'>
                <Text className='font-extrabold text-green-600 ml-3'>ADD ALL</Text>
              </Pressable>
